...
public class CalcolatriceInterna extends JFrame {
    ...
    public CalcolatriceInterna() {
        ...
        GestoreScelta gestore = new CalcolatriceInterna.GestoreScelta();
